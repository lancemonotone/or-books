...
const COPY = {
  ...
  decisionsLead: (n) =>
    `${n} questions need an answer before we can move ahead on a few items.`,
  reviewDecisions: 'Answer the questions',
  allPhases: 'All phases',
  openPhase: 'Open phase',
  whatWeFound: 'What we found',
  whatWeSuggest: 'What we suggest',
  screenshotsHeading: 'Screenshots',
  screenshotsGallery: 'Screenshots and videos',
  screenshotsLead: 'Everything we captured, linked to the issues below.',
  ...
  decisionsPageLead: 'Your answers tell us how to handle the items marked below.',
